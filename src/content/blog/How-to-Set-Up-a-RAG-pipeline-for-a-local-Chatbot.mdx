...
Clone the repo locally into wherever you want, using git. You can download Git \<a href='[https://git-scm.com/downloads/win](https://git-scm.com/downloads/win)\`>here\</a>, or you can simply choose to download the zip for the repo and unpack it wherever you desire. Then, open the repository's directory, and inside it you'll need to make a directory called .streamlit. In this directory, you must construct a secrets.toml file. This is where your OpenAI API key will go. Simple create a field called "openai_key", assign it the value of your API key, enclosed within quotes to make it a string, and save the file.
