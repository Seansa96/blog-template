...
* **Rolling Rubbish** - Stix will select up to four non-tanks, plus the active tank, to become balls of garbage (yes, your raid members are now objectively trash).  You will have a meter that fills up with each pile of garbage or add you run over.  You may *only* run over small piles of garbage/hyenas at first, and once you have filled up your meter halfway you may then begin collecting larger piles of garbage/scrapmasters.  Running into the boss with a **Rolling Rubbish** ball will also deal up to 1.5% of its health, based on the ball's size.
...
* **Dumpster Dive** <img src="https://cdn.shawnzhome.com/shawnzhome/videos/LoU/converted-stix/dumpsterdive.webp"/>
* **Scrap Rockets** <img src="https://cdn.shawnzhome.com/shawnzhome/videos/LoU/converted-stix/scraprocket.webp"/>
...
* **For Tanks**, you need to be aware of **Demolish** and **Meltdown**. These are not always used back to back, but **Meltdown** can be semi-threatening if you have **Demolish** when it comes in. You should be aware that sometimes, **Demolish** will just precede an **Electromagnetic Sorting**, but you only swap on **Sorting**
...
As I mentioned in the <a href="#strategy-normal-and-heroic">Strategy</a> section, you basically will just be swapping on each **Demolish**. Sometimes, he'll follow up **Demolish** directly into an **Electromagnetic Sorting**, in which case it's better to wait a second for that tank to be made a ball and *then* taunt, so that you don't have the **Demolish** debuff while you're actively tanking. You can live his **Meltdown** while you have it, but it's just unnecessary damage.
...
<a href="https://discord.com/channels/1353297912754602097/1353301271469363282">Feedback or opinions? Drop them here in the discord thread for this post!</a>