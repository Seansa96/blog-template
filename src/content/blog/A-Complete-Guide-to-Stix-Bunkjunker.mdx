...
* **For Tanks**, you need to be aware of **Demolish** and **Meltdown**. These are not always used back to back, but **Meltdown** can be semi-threatening if you have **Demolish** when it comes in. You should be aware that sometimes, **Demolish** will just precede an **Electromagnetic Sorting**, and taunt accordingly.
