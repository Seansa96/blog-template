...
<ul>
	<li>
		Enchanted Weathered Harbinger Crest - A R5 craft producing a 590 piece of gear. \*\*THIS DOES
		NOT REQUIRE A SPARK, AND CAN ONLY BE USED ON CRAFTED GEAR THAT DOES NOT REQUIRE A SPARK TO BE
		MADE
	</li>
