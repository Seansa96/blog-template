...
* **Unyielding Belligerent** - These will cast **Unyielding Fervor**, enraging them. These melee fairly hard, and this cast exacerbates this.
...
* **Plague Bolt** - A spammable, interruptible cast that deals moderate damage.
...
* **Shackled Soul** - These cast **Bind Soul**, a channel on a random player that does quite high damage and slows their target.
...
* As of writing, any ranged can simply stand outside of the arena and DPS the boss freely without worrying about the orbs. Melee and tanks should dodge as best as they can.
...
* For the **Draw Soul**, there should be an agreed upon location in which to stack these, and all players should loosely stack there (including the tank). At that point, these souls should be burned down and cc'ed as needed.
...
* **Rancid Gasbag** - You should strive not to pull either of the two patrolling **Gasbags**, after the first bridge, as they can be easily skipped, but you will be forced to fight the one just before **Gorechop**. It has two abilities. One is a passive that does moderate rot to the entire group, called **Disease Cloud**, and the other is a "frontal-backal" called **Vile Eruption**, disorienting and dealing moderate damage to anyone hit.
