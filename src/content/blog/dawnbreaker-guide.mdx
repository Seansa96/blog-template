...
**NOTE: SOME THINGS ARE OUT OF DATE AND THIS DUNGEON IS ALSO MUCH EASIER THAN IT WAS ON BETA. THE SECOND BOSS TANK LOCATION RECOMMENDED HERE IS NO LONGER RELEVANT, AS HE DOES NOT PATROL AND IS A STATIC SPAWN. WILL BE UPDATED AS TIME PERMITS**
...
I recommend lusting the first pull, and then on CD. If you are particularly scared of Anub'ikkaj, you can clear trash until lust is back up for him.
