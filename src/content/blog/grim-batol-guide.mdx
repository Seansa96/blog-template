...
- **Twilight Bolt** does a moderate amount of damage, but **Enveloping Shadows** is the real threat. It puts a massive heal absorb on two players while also afflicting them with a DoT. Combining these with other mob types can quickly get out of hand.
...
First pack->On CD for hard pull/second boss, whichever is first->On CD/last boss->last boss
