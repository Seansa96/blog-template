...
* **Velaryn** now casts **The Hunt** three times in a row, staggered, and this occurs after each **Sigil of Chains** cast.  Soaking **The Hunt** now also applies a debuff that increases damage taken by the ability by 500% for 10 seconds, requiring 3 groups of players now to soak all lines. <img src="https://s3.us-east-1.amazonaws.com/cdn.shawnzhome.com/shawnzhome/videos/MO/soulhunters/thehuntmythic.webp"/>
* **Eye Beam** now also increases the damage taken from **Felblade** as well.
* **Ilyssa** now uses **Sigil of Chains** pulling the entire raid to her location after a 2.5 second cast. <img src="https://s3.us-east-1.amazonaws.com/cdn.shawnzhome.com/shawnzhome/videos/MO/soulhunters/sigilofchains.webp"/>
* In each intermission, all players are chained in groups of 3 players shortly before it begins.  <img src="https://s3.us-east-1.amazonaws.com/cdn.shawnzhome.com/shawnzhome/videos/MO/soulhunters/soultether.webp"/>
...
This can be a rather annoying encounter to tank, due to the nature of the tank swaps and needing to keep the DPS satiated as the bosses jump around.  You should do your best to keep things together for cleave and be aware of moments when you are quite vulnerable, like during **Fracture**.  Be careful where you point **Eye Beam**, and during **Collapsing Night** you can make the fight much easier on healers by doing a lot of soaking.

# Notes on Healing

The damage on this fight is quite spiky, and tends to be concentrated on a few players at a time.  The most difficult part of the fight to heal is the **Fel Rush** intermission, where players can very quickly dip to low HP threshholds and need quick spot healing. Be aware that you should make sure you don't dispel the **Devourer's Ire** until players have soaked a decent amount, usually around 5-7 stacks.

# Damage Profile Best Suited for this Encounter

You should choose a loadout that gives you strong 3 target cleave, as that is the majority of the fight.
