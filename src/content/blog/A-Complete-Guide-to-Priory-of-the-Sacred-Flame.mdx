...
A mini-boss sits in the middle of this room, accompanied by two **Devout Priests**. It MAY be possible to skip this by getting count elsewhere, which is certainly preferable.
...
* **Neophytes are the absolute highest priority while they are alive**. You will get one set of them, and if you defeat them with everyone alive the fight is essentially done.
