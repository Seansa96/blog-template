...
Unlike most dungeons, there is a buff present here available for use if you have a **Paladin** or **Priest**, although it is of current tuning no longer mandatory and has become quite weak, but it is still free damage in the most overtuned dungeon and should be considered when forming a composition.

You will want a balanced composition for this encounter, as too many melee can make the second and third bosses quite difficult.
