...
* **Salhadaar** will begin the phase with a **Galactic Smash**. The targeted players should run out and try to get equidistant from each other, going about halfway of the radius (so, halfway between the centerpoint of the room to the edge of the platform) The rest of the raid should remain in the middle of the room until the **Dark Stars** are spawned.  Defensives and personals should be used for each **Galactic Smash**, as this will be a massive amount of damage.
