...
* **Unruly Stormrook -** These will cast an ability every so often called **Energized Barrage**, which deals very high damage in a channel over 3 seconds. You should wait until the channel begins, then stop it, as this will put the ability on cooldown but prevent it from doing the full damage.
