...
This is a fairly short but intense dungeon (as of current tuning), with some of the hardest trash in all of Season Two, with bosses increasing in difficulty. It is fairly linear with little routing choices available.

Melee are a bit of a detriment here, and you should consider bringing as little as you can. If it allows, you may consider wanting to bring an extra magic dispel, or someone who can dispel curses.
...
* **Unruly Stormrook -** These will cast an ability every so often called **Energized Barrage**, which deals very high damage in a channel over 3 seconds.  Kicking this is a high priority, but if you lack the kicks to do so, you should wait until the channel begins, then stop it, as this will put the ability on cooldown but prevent it from doing the full damage.
...
* **Wild Lightning** <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/wildlightning.webp"/>
* **Localized Storm** <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/localizedstorm.webp"/>
...
* <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/wildlightningboss.webp"/>
* **Crashing Thunder** - **Kyrioss** afflicts the entire party with impending thunder, and after several seconds each player will take a moderate burst of damage to themselves and anyone else within 8 yards.
* <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/crashingthunder.webp"/>
...
* <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/lightningtorrent.webp"/>
...
* <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/lightningdash.webp"/>
**Strategy**
...
* **Coalescing Void Diffuser** - The main lieutenant mob of this area. They have two casts, one of which is particularly dangerous. **Attracting Shadows**, which is a channeled AoE that pulses high damage while dragging in all players towards them, ending in a massive burst of damage to anyone too close, and **Arcing Void**, a moderate-length cast that hits multiple targets for moderate damage, reducing with each jump.
* **Attracting Shadows** <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/attractingshadows.webp"/>
...
* **Instability** <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/instability.webp"/>

# Stormguard Gorren

You will want to lust this. This is a short but stressful encounter that, when played properly, is simply a healing check. However, it can go south very quickly and is incredibly punishing on mistakes.

* **Crush Reality** - **Gorren** will leap towards a random player, preferring ranged, and deal lethal damage to anyone he lands on after a short moment.  This also does a blast of moderate damage to the group.  The area he landed on will be covered in **Lingering Void**, which slowly expands a little further and does high ticking damage to anyone caught. **Reality Tears** will also be ejected shortly after, sending four tornadoes out to dodge, which also deal very high damage to anything hit.
* <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/crushreality.webp"/>
* **Chaotic Corruption** - **Gorren** will afflict a random player with this debuff, dealing high damage over its duration. This DoT has 4 charges, and will keep jumping to the nearest player until it is fully expended.  When it jumps, it will deal damage to anyone within the radius indicated, and it will scar the player who had it with **Chaotic Vulnerability**, increasing their damage taken from it by 100%, stacking.
* <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/chaoticcorruption.webp"/>
...
* <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/darkgravity.webp"/>
...
* You will want to pass the **Chaotic Corruption** from DPS->Tank->Other DPS->Tank. As there isn't much tank damage on this fight, this makes it much easier on the party as a whole.
* One of the DPS **Corruptions** will line up with a **Crush Reality**. They should personal this or likely die.
* I prefer to tank the boss near the bait spot, as the tornadoes are not too difficult to dodge and this ensures much higher uptime for the melee and prevents the baiting players from having range issues with anyone.

# Trash to Voidstone Monstrosity

This area is overall easier than the previous, but still has some nasty pulls and you can quite easily die if you lose focus.  Throughout the area, an NPC will grant you an ExtraActionButton that can be used to stun *any* creature after a moderate delay. This ability will rotate throughout the group, and you should simply send it as you get it to ensure it continues rotating quickly.  You will need to use this ability to interrupt one of the mobs in this area.
...
* **Umbral Wave** <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/umbralwave.webp"/>
* **Void-Cursed Crushers and Afflicted Civilians make a return**
* **Consuming Voidstone** - The other lieutenant mob in this area. They have 3 abilities of note. The first is **Volatile Void**, a passive that causes their auto-attacks to cleave to anything within 3 yards of their target.  The second is **Void Extraction**, which after a cast will siphon power from nearby allies, weakening them but increasing the **Voidstone's** damage done.  Lastly, as they fall to low health, they will cast **Unleash Darkness**, channeling until death, causing swirlies to appear beneath players that erupt, dealing lethal damage a short moment afterwards.
* **Unleash Darkness** <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/unleashdarkness.webp"/>

# Voidstone Monstrosity

This is a moderately difficult encounter in an uncoordinated group at higher levels, with a few quirks as of writing that make it quite annoying even in an experienced team. The boss begins with a shield, and after breaking that shield is stunned and takes massively increased damage, at which point you should use your cooldowns.
...
* <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/oblivionwave.webp"/>
...
* **Null Upheaval** - The boss will smash the platform, knocking all players back and dealing moderate damage to them. He will then eject four **Voidstone Fragments** in semi-random locations around the arena, and spawn a large amount of swirlies. Each **Fragment** left un-touched, evolves into a **Voidstone Awakened**, which are regular mobs that pulse very high damage to the group.
* <img loading="lazy" src="https://cdn.shawnzhome.com/videos/rookery/nullupheaval.webp"/>
* **Stormrider's Charge** - The NPC that assisted you throughout the trash in this area returns, granting everyone but the tank (if all players are alive) 100% movement speed and a buff that, upon expiration, destroys any **Fragments** within the indicated radius.


**Strategy**

* As even a single **Voidstone Awakened** will wipe you without massively overgearing the key level and using CDs, it is necessary to divide the group up in order to be able to destroy each **Fragment**.  As mentioned, there will always be 4 **Fragments**, but their locations are not guaranteed.
...
* **Fragments** can spawn in doubles in one section, or equally distributed througuhout. You should generally assign 1 non-tank to each section (left, middle, and right) before the pull. The last person can float.
* In the event two **Fragments** spawn on one section, there is also this caveat: the double can spawn close enough that one player can destroy both, or far enough apart that two players are required.  This is where the floater must truly pay attention, and pings or other communication should be used in this event.
...
* As mentioned before, the boss is stunned and takes increased damage when his shield is broken. However, do note that this stun is casted by the aiding NPC, and prevents him from casting anything else. This means that, if you break the shield as a **Null Upheaval** goes out, you will not gain **Stormrider's Charge**, and thus be unable to break any **Fragments**. You should watch the health and timers to prevent such an overlap, until they undoubtedly fix this oversight.
...
This is the route I recommend in a PUG.
...
* While falling to the second area of trash (after **Kyrioss** is dead), if you use your ExtraActionButton to dash to a **Stormrook** you gain a buff that provides AoE damage for some time.  No clip as of yet of this.