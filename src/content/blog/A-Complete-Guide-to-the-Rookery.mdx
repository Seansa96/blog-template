...
* While falling to the second area of trash (after **Kyrioss** is dead), if you use your ExtraActionButton to dash to a **Chained Stormrook** you gain a buff that provides AoE damage for some time. Works in non m+, will be testing if it works in keys before 11.1 drops. <img loading="lazy" src="https://s3.us-east-1.amazonaws.com/cdn.shawnzhome.com/shawnzhome/videos/rookery/rookerybuff.webp"/>
