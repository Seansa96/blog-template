...
* As even a single **Voidstone Awakened** will wipe you without massively overgearing the key level and using CDs, it is necessary to divide the group up in order to be able to destroy each **Fragment**.  As mentioned, there will always be 3 **Fragments**, but their locations are not guaranteed.
...
* While falling to the second area of trash (after **Kyrioss** is dead), if you use your ExtraActionButton to dash to a **Stormrook** you gain a buff that provides AoE damage for some time.  No clip as of yet of this, and not 100% confirmed to scale or be worth doing. Plan to test this before 11.1.