...
With **Prioress and Baron** nerfed, this is now the reigning hardest boss of all Season 2 as of current writing, and an extreme heal check despite having periods in which little damage is outgoing.
...
The below is out-of-date as **Blizzard** has altered some packs and moved others. The 3rd Weapon Stockpile you need is now above the Dam guarded by the **Bloodwarper** pack there. As of March 1st, this has not been yet fixed on Keystone.Guru or the MDT addon itself.
